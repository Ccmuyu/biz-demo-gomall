...
func (p *GreetResp) GetRespBody() (v string) {
	return p.RespBody
}
...
type HelloService interface {
	...
	Greet(ctx context.Context, request *GreetReq) (r *GreetResp, err error)
}
...
func (p *HelloServiceClient) Greet(ctx context.Context, request *GreetReq) (r *GreetResp, err error) {
	var _args HelloServiceGreetArgs
	_args.Request = request
	var _result HelloServiceGreetResult
...
func NewHelloServiceProcessor(handler HelloService) *HelloServiceProcessor {
	...
	self.AddToProcessorMap("Greet", &helloServiceProcessorGreet{handler: handler})
	return self
}
...
type helloServiceProcessorGreet struct {
	handler HelloService
}

func (p *helloServiceProcessorGreet) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := HelloServiceGreetArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := HelloServiceGreetResult{}
	var retval *GreetResp
	if retval, err2 = p.handler.Greet(ctx, args.Request); err2 != nil {
...
type HelloServiceGreetArgs struct {
	Request *GreetReq `thrift:"request,1"`
}

func NewHelloServiceGreetArgs() *HelloServiceGreetArgs {
	return &HelloServiceGreetArgs{}
}

var HelloServiceGreetArgs_Request_DEFAULT *GreetReq

func (p *HelloServiceGreetArgs) GetRequest() (v *GreetReq) {
	if !p.IsSetRequest() {
		return HelloServiceGreetArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_HelloServiceGreetArgs = map[int16]string{
	1: "request",
}

func (p *HelloServiceGreetArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *HelloServiceGreetArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HelloServiceGreetArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *HelloServiceGreetArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewGreetReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *HelloServiceGreetArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *HelloServiceGreetArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *HelloServiceGreetArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HelloServiceGreetArgs(%+v)", *p)

}

type HelloServiceGreetResult struct {
	Success *GreetResp `thrift:"success,0,optional"`
}

func NewHelloServiceGreetResult() *HelloServiceGreetResult {
	return &HelloServiceGreetResult{}
}

var HelloServiceGreetResult_Success_DEFAULT *GreetResp

func (p *HelloServiceGreetResult) GetSuccess() (v *GreetResp) {
	if !p.IsSetSuccess() {
		return HelloServiceGreetResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_HelloServiceGreetResult = map[int16]string{
	0: "success",
}

func (p *HelloServiceGreetResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *HelloServiceGreetResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HelloServiceGreetResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *HelloServiceGreetResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewGreetResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *HelloServiceGreetResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *HelloServiceGreetResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *HelloServiceGreetResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HelloServiceGreetResult(%+v)", *p)
